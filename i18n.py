...
_EN: dict[str, str] = {
    ...
    "Aus Backup wiederherstellen": "Restore from backup",
    "Backup erstellt:\n{p}": "Backup created:\n{p}",
    "Backup fehlgeschlagen.": "Backup failed.",
    "Backup auswählen": "Select backup",
    "Datenbank (*.db)": "Database (*.db)",
    "Wiederherstellen": "Restore",
    "Alle aktuellen Daten werden durch das Backup ersetzt. Fortfahren?": "All current data will be replaced by the backup. Continue?",
    "Daten wiederhergestellt.": "Data restored.",
    "Wiederherstellung fehlgeschlagen.": "Restore failed.",
    "Arbeitstage": "Workdays",
    "Arbeitstage & Soll pro Wochentag:": "Workdays & target per weekday:",
    "Häkchen = Arbeitstag; die Zeit ist das jeweilige Tagessoll.": "Check = workday; the time is that day's target.",
    "Typ:": "Type:",
    "Arbeit": "Work",
    "Urlaub": "Vacation",
    "Krank": "Sick",
    ...
    "Von:": "From:",
    "Abwesenheit vom {a} bis {b} ({n} Tage) wirklich löschen?":
        "Really delete the absence from {a} to {b} ({n} days)?",
    "Monats-PDF (.pdf)": "Monthly PDF (.pdf)",
    "Monats-PDF exportieren": "Export monthly PDF",
    "Stundennachweis {m} {y}": "Time log {m} {y}",
    "Monats-PDF erfolgreich exportiert!": "Monthly PDF exported successfully!",
    "Tag": "Day",
    "Zeiten / Typ": "Times / Type",
    "Soll:": "Target:",
    "Saldo:": "Balance:",
    "Lfd.": "Run.",
    "Monatssumme": "Monthly total",
    "Datum:": "Date:",
